...
I currently use Javascript most of the time for developement, whether it is web(MERN-full Stack) or mobile(React Native) or desktop(ElectronJS) development. -->
